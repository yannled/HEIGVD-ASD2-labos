...
${OBJECTDIR}/GraphUsingAdjacencyLists.o: GraphUsingAdjacencyLists.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GraphUsingAdjacencyLists.o GraphUsingAdjacencyLists.cpp

${OBJECTDIR}/GraphUsingAdjacencyMatrix.o: GraphUsingAdjacencyMatrix.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GraphUsingAdjacencyMatrix.o GraphUsingAdjacencyMatrix.cpp

${OBJECTDIR}/GraphUsingListOfEdges.o: GraphUsingListOfEdges.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GraphUsingListOfEdges.o GraphUsingListOfEdges.cpp
