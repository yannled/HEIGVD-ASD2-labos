...
#ifndef ARBREHUFFMANFEUILLE_H
#define	ARBREHUFFMANFEUILLE_H
...
class ArbreHuffmanFeuille : public ArbreHuffman {
public:
     ...
     */
    ArbreHuffmanFeuille(char caracter);
